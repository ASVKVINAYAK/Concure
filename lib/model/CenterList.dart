...
class CenterDetails {
  ...
  factory CenterDetails.fromMap(Map<String, dynamic> json) => CenterDetails(
    ...
    sessions: json["sessions"] == null
        ? null
        : List<SessionDetails>.from(
        json["sessions"].map((x) => SessionDetails.fromMap(x))),
  );
...
class SessionDetails {
  ...
  factory SessionDetails.fromJson(String str) => SessionDetails.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory SessionDetails.fromMap(Map<String, dynamic> json) => SessionDetails(
